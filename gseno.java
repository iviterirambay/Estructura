...
FUE HECHO EN JAVA JDK VERSIÓN 1.6.0
Y PROBADO CON  JCREATOR 3.50
...
public class gseno extends Frame
{
	...
	public gseno()
	{
		...
		setTitle("GRAFICA DE LA FUNCION SENO *******  POR IRWIN ALBERTO VITERI RAMBAY  *********");
		setSize(1000,700);
		setVisible(true);
